...
<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyAMBUVJ3FwsPCObvtjgl4E3LOIYxnX-Ynw&sensor=false">
</script>
<script>
	...
	<div class="container">
		...
		<div class="loginBar">
			<div class="loginBarInfo">
				<p>Sisselogitud kasutaja: ${nimi}</p> <a href="javascript:void(0)" onclick="logout()"> Logi välja</a>
			</div>
		...
		<div class="subcontainer" id="sisu" style="display:block;">
			...
			<div class="sisu_a" id="valima" style="display:none;">				
				<div class="login">
					<h2>H��letamiseks pead end k�igepealt tuvastama. Sisesta oma ID-kaardi kasutajatunnus ja parool.</h2>
					<input class="input" type="text" placeholder="Kasutajanimi">
					<input class="input" type="password" placeholder="Parool">
					<form action="javascript:void(0)">					
			...
			<div class="kinnitus">
				<h3>Valige kandidaat kellele soovite oma hääle anda.</h3>
